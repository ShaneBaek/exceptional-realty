$(function() {
  ...
  Property.displayContent = function() {
    ...
    $.each(Property.all, function(i, property) {
      ...
      $('table').stupidtable(); //jquery table plugin
  };
  ...
  var property3 = new Property("14A Belmont Way", "Bronx", "NY", 874000 , "2015 Jan 23");
  var property3 = new Property("455 Crazy lane", "Queens", "NY", 555000 , "2015 Jan 24");
